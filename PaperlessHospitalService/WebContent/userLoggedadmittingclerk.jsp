...
#dropbutton1{text-decoration:none;position:absolute; left : 0px;top : -16px;width:150px;max-width:150px; max-height: 30px;border:dotted 2px black;padding:10px 0px 10px 0px;}

#dropbutton2{text-decoration:none;position:absolute; left : 0px;top : 33px;width:150px;max-width:150px; max-height: 30px;border:dotted 2px black;padding:10px 0px 10px 0px;}

#dropbutton3{text-decoration:none;position:absolute; left : 0px;top : 82px;width:150px;max-width:150px; max-height: 30px;border:dotted 2px black;padding:10px 0px 10px 0px;}
...
<p id="username"><%=session.getAttribute("currentSessionUserfname")%> <%=" "%><%=session.getAttribute("currentSessionUserlname")%></p></p>
	...
	<div id="sidebox1">
		...
		<p id="sidebutton1" ><a onClick="sidebutton1.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s1" href="getpatient.html" target="frame1">Get Patient</a></p>

		<p id="sidebutton2" ><a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="PatientRegistration.html" target="frame1">New Registration</a></p>

		<p id="sidebutton3" ><a onClick="sidebutton3.style.background='green';sidebutton2.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s3" href="sendnewregisteredpatient.jsp" target="frame1">Send New Patient</a></p>

		<p id="sidebutton4" ><a onClick="sidebutton4.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s4" href="updateregistrationfee.jsp" target="frame1">Receive Fee</a></p>
