...
#hospitallogo{ position : absolute;width:200px; height:70px;left:200px;top:0px;z-index:10;}
...
#home{position : absolute; left : 20px; top : 20px;z-index:11;}
...
#sidebutton1{ padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px; top : 250px;}

#sidebutton1:hover

{-webkit-border-radius: 0px 20px 20px 0px;box-shadow:2px 0px 2px black;}

#sidebutton2{  top : 290px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}

#sidebutton2:hover

{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}

#sidebutton3{  top : 330px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}

#sidebutton3:hover

{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}

#sidebutton4{  top : 370px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}

#sidebutton4:hover

{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}

#sidebutton5{  top : 410px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}

#sidebutton5:hover

{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}

#sidebutton6{  top : 450px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}

#sidebutton6:hover

{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}

#sidebutton7{  top : 490px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}
...
#upbutton7{  -webkit-border-radius: 5px;position : absolute; left : 480px; top : 10px; padding : 10px 30px 10px 30px; background-color : lightgreen;}

#upbutton7:hover{top : 5px;}
...
<p id="welcome">Welcome</p>
		<p id="username"><%=session.getAttribute("currentSessionUserfname")%> <%=" "%><%=session.getAttribute("currentSessionUserlname")%></p>
	...
	<div id="sidebox1">
		...
		<p id="sidebutton1" ><a onClick="sidebutton1.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s1" href="createuser.jsp" target="frame1">Create User</a></p><br>

		<p id="sidebutton2" ><a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="deleteuser.jsp" target="frame1">Delete User</a></p>

		<p id="sidebutton3" ><a onClick="sidebutton3.style.background='green';sidebutton2.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s3" href="modifyrole.jsp" target="frame1">Modify Role</a></p>

		<p id="sidebutton4" ><a onClick="sidebutton4.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s4" href="createrecord.jsp" target="frame1">Create RECORD</a></p>

		<p id="sidebutton5" ><a onClick="sidebutton5.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';" id="s5" href="deleterecord.jsp" target="frame1">Delete RECORD</a></p>
		
		<p id="sidebutton6" ><a onClick="sidebutton5.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';" id="s5" href="viewfeedback.jsp" target="frame1">Collect Feedback</a></p>

        <p id="sidebutton7" ><a onClick="sidebutton5.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';" id="s5" href="createbackup.jsp" target="frame1">Create Backup</a></p>
