...
#s8{ text-decoration : none;color:black;}
...
#sidebutton7:hover
{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}
#sidebutton8{  top : 530px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}
#sidebutton8:hover
{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}
...
<p id="welcome">Welcome</p>
	...
	<div id="sidebox1">
		...
		<hr id="side1">
		<p id="sidebutton1" ><a onClick="sidebutton1.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';sidebutton6.style.background='lightgreen';" id="s1" href="viewhealthrecord.jsp" target="frame1">VIEW HEALTH RECORD</a></p>
		<p id="sidebutton2" ><a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';sidebutton6.style.background='lightgreen';" id="s2" href="updatepatientrecord.jsp" target="frame1">UPDATEHEALTHRECORD</a></p>
		<p id="sidebutton3" ><a onClick="sidebutton3.style.background='green';sidebutton2.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';sidebutton6.style.background='lightgreen';" id="s3" href="manageinpatient.jsp" target="frame1">MANAGE PATIENT</a></p>
		<p id="sidebutton4" ><a onClick="sidebutton4.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';sidebutton6.style.background='lightgreen';" id="s4" href="viewdischargeintimation.jsp" target="frame1">DISCHARGEINTIMATION</a></p>
		<p id="sidebutton5" ><a onClick="sidebutton5.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton6.style.background='lightgreen';" id="s5" href="requesttodept.jsp" target="frame1">REQUESTTODEPT</a></p>
	    <p id="sidebutton6" ><a onClick="sidebutton6.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s6" href="generatereport.jsp" target="frame1">GENERATEREPORT</a></p>
	    <p id="sidebutton7" ><a onClick="sidebutton7.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s6" href="viewresponsesbyda.jsp" target="frame1">RESPONSES</a></p>
		<p id="sidebutton8" ><a onClick="sidebutton8.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s6" href="viewdailystatus.jsp" target="frame1">View Daily Status</a></p>
	</div>
	<!--<div id="upbox1">
	...
	<div id="dropbox1">
		...
		<center><p id="dropbutton2"  target="frame1"><a href="accountsetting.jsp" target="frame1">ACCOUNT SETTINGS</a></p></center>
