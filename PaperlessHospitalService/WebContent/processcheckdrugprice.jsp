...
Statement stmt = null;
	...
	try
   {
        ...
        String sql;
        sql="SELECT * FROM SAIRAM.DRUG where drug_id='"+t1+"'";
        //ps.setString(1,t3);
        stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(sql);
        %>
        <table border="1"><tr><th>DRUG_ID</th><th>DRUG_NAME</th><th>COMPANY_NAME</th><th>BATCH_NAME</th><th>COMPOSITION</th><th>ARRIVAL_DATE</th><th>EXPIRY_DATE</th><th>PRICE_PER_UNIT</th><th>QUANTITY</th></tr>
<%
        while ( rs.next() ) {
