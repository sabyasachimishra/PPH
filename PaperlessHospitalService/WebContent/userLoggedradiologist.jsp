...
#hospitallogo{ position : absolute;width:100px; height:35px;left:200px;top:0px;}
...
<p id="welcome">Welcome</p>
	...
	<div id="sidebox1">
		...
		<hr id="side1">
		<p id="sidebutton1" ><a onClick="sidebutton1.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s1" href="viewradiorequest.jsp" target="frame1">VIEW REQUEST</a></p>
		<p id="sidebutton2" ><a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="investigation.jsp" target="frame1">UPDATEINVESTIGATION</a></p>
		<p id="sidebutton3" ><a onClick="sidebutton3.style.background='green';sidebutton2.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s3" href="responsetoda.jsp" target="frame1">SEND RESPONSE</a></p>
		<p id="sidebutton4" ><a onClick="sidebutton4.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s4" href="generatereport.jsp" target="frame1">GENERATE REPORT</a></p>
	...
	<div id="dropbox1">
		<center><p id="dropbutton1"  target="frame1"><a href="viewprofile.jsp">VIEW PROFILE</a></p></center>
		<center><p id="dropbutton2" target="frame1"> <a href="accountsetting.jsp"> ACCOUNT SETTINGS</a></p></center>
		<center><p id="dropbutton3"  target="frame1"><a href="signout.jsp">LOG OUT</a></p></center>
	</div>
	<div id="lowbox1">
