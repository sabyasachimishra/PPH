...
<p id="welcome">Welcome</p>
	...
	<img id="profilepic" src="<%=session.getAttribute("currentSessionUserId")%>.jpg">
		...
		<p id="sidebutton1" ><a onClick="sidebutton1.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s1" href="Viewpatientrecord.jsp" target="frame1">View Patient Record</a></p>

		<p id="sidebutton2" ><a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="Updatepatientrecord.jsp" target="frame1">Update Patient Record</a></p>
	...
	<div id="dropbox1">
		...
		<center><p id="dropbutton2"> <a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="\\C:\Users\Sumit\Desktop\UI\account.html" target="frame1">Account Setting</a></p></center>

		<center><p id="dropbutton3">Log out</p></center>
