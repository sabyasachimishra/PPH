...
#upbutton2{ position : absolute; left : 145px; top : 10px;-webkit-border-radius: 5px; padding : 10px 30px 10px 30px; background-color : lightgreen;}
#upbutton2:hover{top : 5px;}
#upbutton3{ position : absolute;-webkit-border-radius: 5px; left : 315px; top : 10px; padding : 10px 30px 10px 30px; background-color : lightgreen;}
...
<div id="upbox1">
		<p id="upbutton1"><a class="oo"  href="viewinpatientenquirybyid.jsp" target="frame1">Enquiry by id</a></p>
		<p id="upbutton2"><a class="oo" href="viewinpatientenquirybyname.jsp" target="frame1">Enquiry by Name</a></p>
		<p id="upbutton3"><a class="oo" href="viewinpatientenquirybydate.jsp" target="frame1">Enquiry by Date</a></p>
