...
<%
    		...
    		try
   {
       ...
       con = DriverManager.getConnection("jdbc:db2://localhost:50000/PAT_DB", "sairam", "prayas");
        ...
        ResultSet rs = statement.executeQuery("select count(*) from sairam.request_to_radiology");
...
<%
		...
		try
   {
       ...
       con = DriverManager.getConnection("jdbc:db2://localhost:50000/PAT_DB", "sairam", "prayas");
        ...
        Statement statement = con.createStatement();
        ResultSet rs = statement.executeQuery("select * from sairam.request_to_radiology where REQUEST_ID='"+t3+"'");
