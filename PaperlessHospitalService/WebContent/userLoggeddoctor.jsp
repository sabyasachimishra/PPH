...
{box-shadow:2px 0px 2px black;-webkit-border-radius: 0px 20px 20px 0px;}
#sidebutton6{  top : 410px;padding : 5px; background-color : lightgreen;width:175px;font-size: 15px;position  :absolute; left : 25px;}
...
<p id="welcome">Welcome</p>
	...
	<div id="sidebox1">
		...
		<p id="sidebutton1" ><a onClick="sidebutton1.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s1" href="updatepatientrecord.jsp" target="frame1">Update Patient Record</a></p><br>

		<p id="sidebutton2" ><a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="viewhealthrecord.jsp" target="frame1">View Patient Record</a></p>

		<p id="sidebutton3" ><a onClick="sidebutton3.style.background='green';sidebutton2.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s3" href="requestbilling.jsp" target="frame1">Request Investigation</a></p>

		<p id="sidebutton4" ><a onClick="sidebutton4.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton1.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s4" href="prescription.jsp" target="frame1">Prescription</a></p>

		<p id="sidebutton5" ><a onClick="sidebutton5.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';" id="s5" href="dischargeintimation.jsp" target="frame1">Send Discharge Intimation</a></p>
		<p id="sidebutton6" ><a onClick="sidebutton5.style.background='green';sidebutton2.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton1.style.background='lightgreen';" id="s6" href="dailystatus.jsp" target="frame1">Update Daily Status</a></p>
	...
	<div id="dropbox1">
		...
		<center><p id="dropbutton3"> <a onClick="sidebutton2.style.background='green';sidebutton1.style.background='lightgreen';sidebutton3.style.background='lightgreen';sidebutton4.style.background='lightgreen';sidebutton5.style.background='lightgreen';" id="s2" href="signout.jsp">Sign Out</a></p></center>
